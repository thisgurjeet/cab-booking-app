...
import 'package:uber/common/controller/services/APIsNKeys/get_service_key.dart';
  ...
  static fetchRideRequestInfo(String rideID, BuildContext context) {
    ...
    ref.once().then((databaseEvent) {
      if (databaseEvent.snapshot.value != null) {
        ...
        PushNotificationDialogue.rideRequestDialogue(rideRequestModel, context);
      }
    ...
    try {
      ...
      var response = await http
          .post(api,
              ...
              body: body)
          .then((value) {
        log('Successfully sent Ride Request');
