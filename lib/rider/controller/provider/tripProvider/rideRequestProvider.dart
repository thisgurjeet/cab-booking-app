...
class RideRequestProvider extends ChangeNotifier {
  ...
  double uberGoCarbonFootprint = 0;
  double uberGoSedanCarbonFootprint = 0;
  double uberPremierCarbonFootprint = 0;
  double uberXLCarbonFootprint = 450.87;
  double uberEVCarbonfootprint = 0;
    ...
    uberXLFare = (baseFare +
     ...
     uberEVFare =    (baseFare +
            uberEVDistancePerKM *
                double.parse(
                    (directionDetails!.distanceInMeter / 1000).toString()) +
            (uberEVDurationPerMinute * (directionDetails!.duration / 60)))
        .round();
    notifyListeners();
  }

  getCarbonFootprint() {
    double baseCarbonFootprint = 0.5;
    double uberGoCarbonFootprintPerKm = 0.20;
    double uberGoSedanCarbonFootprintPerKm = 0.22;
    double uberPremierCarbonFootprintPerKm = 0.24;
    double uberXLCarbonFootprintPerKm = 0.3;

    double distanceInKm = directionDetails!.distanceInMeter / 1000;

    uberGoCarbonFootprint =
        (baseCarbonFootprint + uberGoCarbonFootprintPerKm * distanceInKm);

    uberGoSedanCarbonFootprint =
        (baseCarbonFootprint + uberGoSedanCarbonFootprintPerKm * distanceInKm);

    uberPremierCarbonFootprint =
        (baseCarbonFootprint + uberPremierCarbonFootprintPerKm * distanceInKm);

    uberXLCarbonFootprint =
        (baseCarbonFootprint + uberXLCarbonFootprintPerKm * distanceInKm);
