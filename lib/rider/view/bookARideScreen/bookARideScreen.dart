...
class _BookARideScreenState extends State<BookARideScreen> {
  ...
  double getCarbonTracking(
    int index,
  ) {
    if (index == 0) {
      return context.read<RideRequestProvider>().uberGoCarbonFootprint;
    }
    if (index == 1) {
      return context.read<RideRequestProvider>().uberGoSedanCarbonFootprint;
    }
    if (index == 2) {
      return context.read<RideRequestProvider>().uberPremierCarbonFootprint;
    }
    if (index == 3) {
      return context.read<RideRequestProvider>().uberXLCarbonFootprint;
    }
    return 0;
  }
                ...
                ElevatedButtonCommon(
                    onPressed: () {
                      ...
                      RideRequestModel model = RideRequestModel(
                        ...
                        carbonTracking: getCarbonTracking(selectedCarType).toString(),
